...
INSERT INTO "new_User" ("admin", "createdAt", "email", "fname", "grade", "id", "lname", "major", "name", "password", "phone", "resetPasswordToken", "resetPasswordTokenExpiry", "resetPasswordTokenUsed", "school", "verificationCode", "verificationCodeExpiry", "verified") SELECT "admin", "createdAt", "email", "fname", "grade", "id", "lname", "major", "name", "password", "phone", "resetPasswordToken", "resetPasswordTokenExpiry", "resetPasswordTokenUsed", "school", "verificationCode", "verificationCodeExpiry", "verified" FROM "User";
DROP TABLE "User";
